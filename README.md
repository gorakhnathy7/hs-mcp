# Hyperswitch TypeScript API Library
...
```sh
npm install git+ssh://git@github.com:gorakhnathy7/hs-mcp.git
```
...
We are keen for your feedback; please open an [issue](https://www.github.com/gorakhnathy7/hs-mcp/issues) with questions, bugs, or suggestions.
