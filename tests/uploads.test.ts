import fs from 'fs';
import type { ResponseLike } from 'hyperswitch/internal/to-file';
import { toFile } from 'hyperswitch/core/uploads';
...
describe('missing File error message', () => {
  ...
  test('is thrown', async () => {
    const uploads = await import('hyperswitch/core/uploads');
    await expect(
