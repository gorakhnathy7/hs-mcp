...
export { ClientOptions } from 'hyperswitch';
...
export function initMcpServer(params: {
  ...
  const client = new Hyperswitch(params.clientOptions);
  const capabilities = {
    ...defaultClientCapabilities,
...
export function init(params: {
  ...
  const client =
    params.client || new Hyperswitch({ defaultHeaders: { 'X-Stainless-MCP': 'true' }, logger: logger });
