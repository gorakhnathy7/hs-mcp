...
export const tool: Tool = {
  ...
  inputSchema: {
    ...
    required: ['connector_id', 'connector_resource_id', 'type', 'X-Idempotency-Key', 'X-Profile-Id'],
    $defs: {
      relay_type: {
        type: 'string',
        enum: ['refund'],
...
export const handler = async (client: Hyperswitch, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(await maybeFilter(jq_filter, await client.relay.create(body)));
};
