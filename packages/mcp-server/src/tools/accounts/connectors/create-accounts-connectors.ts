...
export const tool: Tool = {
  name: 'create_accounts_connectors',
  description:
  ...
  inputSchema: {
    ...
    required: ['account_id', 'connector_name', 'connector_type'],
    $defs: {
      connector: {
        type: 'string',
        enum: [
...
export const handler = async (client: Hyperswitch, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(await client.accounts.connectors.create(account_id, body));
};
