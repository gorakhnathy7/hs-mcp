...
export const metadata: Metadata = {
  ...
  tags: [],
  httpMethod: 'get',
  httpPath: '/customers/{customer_id}/payment_methods',
  operationId: 'List all Payment Methods for a Customer',
};

export const tool: Tool = {
  name: 'list_customers_payment_methods',
...
export const handler = async (client: Hyperswitch, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(await client.customers.paymentMethods.list(customer_id, body));
};
