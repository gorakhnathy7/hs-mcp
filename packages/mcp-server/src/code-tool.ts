...
import Hyperswitch, { ClientOptions } from 'hyperswitch';
...
export function codeTool(): Endpoint {
  ...
  const handler = async (client: Hyperswitch, args: unknown) => {
    ...
    try {
      const resp = await new Promise<Response>((resolve, reject) => {
        ...
        const opts: ClientOptions = {
          ...
          ephemeralKey: client.ephemeralKey,
          jwtKey: client.jwtKey,
